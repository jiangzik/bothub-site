...
<p>Sign in once and you're talking to the world's top AI models on a single account — no provider keys to apply for. Free credits on signup, so you can start building right away.</p>
...
<p>Cron or countdown. The bot runs on its own. Results flow back to the chat, or out to Feishu / Telegram.</p>
</div>
<div class="bothub-feature">
...
<ul>
<li><bothub-icon name="i-lucide-message-circle"></bothub-icon><span>Core chat</span></li>
<li><bothub-icon name="i-lucide-share"></bothub-icon><span>Tool capabilities via paired Mac desktop</span></li>
<li><bothub-icon name="i-lucide-clock"></bothub-icon><span>TestFlight invite coming</span></li>
</ul>
</div>
</div>
...
<div class="bothub-download-note"><bothub-icon name="i-lucide-apple"></bothub-icon> macOS shows "is damaged" on first launch? The app is unsigned, not actually damaged — see the <a href="/en/quick-start/macos-install">macOS Install Guide</a> to unblock. The Linux build hasn't been thoroughly tested yet — feedback welcome.</div>
