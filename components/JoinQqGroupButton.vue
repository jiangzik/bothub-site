...
const props = withDefaults(defineProps<{ label?: string; idLabel?: string }>(), {
  label: 'Join QQ Group',
  idLabel: 'QQ Group',
})

const QQ_GROUP_URL = 'https://qm.qq.com/q/sWqmwBTc76'
const QQ_GROUP_ID = '292036480'
</script>
...
<template>
  ...
  >
    <span class="bothub-qq-icon">
      <svg viewBox="0 0 24 24" class="bothub-qq-svg" aria-hidden="true">
        <path
          fill="currentColor"
